...
class OptimTool(NextPointAlgorithm):
    ...
    def get_samples_for_iteration(self, iteration):
        ...
        print (samples)
        samples.reset_index(drop=True, inplace=True)
        print ('samples after reset')
        print(type(samples))
        print (samples)
        print ('samples after generate_samples_from_df')
        print(type(self.generate_samples_from_df(samples)))
        print (self.generate_samples_from_df(samples))
        print ('state')
